    ...
    () =>
      [
        { field: "id", headerName: "ID", flex: 0.45, minWidth: 70 },
        {
          ...
          flex: 1.4,
          minWidth: 220,
          renderCell: (p: GridRenderCellParams<any, any, any>) => (
            <Stack spacing={0.4} sx={{ py: 0.5 }}>
              <Typography sx={{ fontWeight: 900, lineHeight: 1.2 }}>{fmtDT((p.row as Row).start_at)}</Typography>
              <Typography variant="caption" color="text.secondary">
                to {fmtDT((p.row as Row).end_at)}
              </Typography>
            </Stack>
          ),
        },
        {
          ...
          minWidth: 170,
          renderCell: (p: GridRenderCellParams<any, any, any>) => (
            <Typography sx={{ fontWeight: 800 }}>{(p.row as Row).client_name}</Typography>
          ),
        },
        { field: "staff_name", headerName: "Staff", flex: 1.1, minWidth: 160 },
        {
          field: "status",
          headerName: "Status",
          flex: 0.9,
